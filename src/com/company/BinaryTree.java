...
public class BinaryTree {
    ...
    public void containsNode(int value) {
        boolean isContains = containsNodeRecursive(root, value);
        System.out.println(isContains ? "Элемент есть в дереве" : "Элемент не найден");
    }
    ...
    private void checkOnTreeEmpty(Node node) {
        if (node == null) {
